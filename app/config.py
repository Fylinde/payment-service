...
class Settings:
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql+psycopg2://postgres:Sylvian@db:5433/payment_service_db")
    DATABASE_USER: str = os.getenv("DATABASE_USER", "postgres")
    DATABASE_PASSWORD: str = os.getenv("DATABASE_PASSWORD", "Sylvian")
    DATABASE_DB: str = os.getenv("DATABASE_DB", "payment_service_db")
    ...
    AUTH_SERVICE_URL = os.getenv("PAYMENT_SERVICE_URL", "http://auth-service")
